...
![](/static/images/sync-map2.png)

现在有需求对Z元素进行修改Z=4，sync.Map会直接修改read map的元素。

![](/static/images/sync-map3.png)
